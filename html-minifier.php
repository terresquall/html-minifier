...
define('HTML_MINIFIER_PLUGIN_VERSION_DATE', '8 May 2018');

add_action('init',array('HTMLMinifier_Manager','init'));
//add_action('upgrader_process_complete', array('HTMLMinifier_Manager','upgrade')); // Run upgrader when the plugin updates.
